      ...
      >
        <nav className="container mx-auto px-6 py-5 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8 text-[15px] font-medium text-slate-500">
            ...
            <a href="https://sarangtumbuh.site/download/windows" className="px-4 py-1.5 rounded-full border border-emerald-500 text-emerald-600 font-bold hover:bg-emerald-50 transition-all flex items-center gap-1 text-xs">
            ...
            <motion.div style={{ y: heroTextY, opacity: heroOpacity }}>
              ...
              <motion.div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                ...
                <div className="flex flex-col gap-2">
                  <motion.a
                    href="https://sarangtumbuh.site/download/windows"
                    whileHover={{ scale: 1.02 }}
                    whileTap={{ scale: 0.98 }}
                  ...
                  <span className="text-[10px] text-slate-400 font-bold uppercase tracking-widest">Available for Windows 10/11</span>
                </div>
              </motion.div>
            </motion.div>
          </div>
