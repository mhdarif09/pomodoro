...
export default function ModulCard({ modul, auth }) {
    ...
    return (
        <div key={modul.id} className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 flex flex-col overflow-hidden">
            {modul.thumbnail && (
            ...
            <div className="p-6 flex flex-col flex-grow">
                ...
                <Link
                    ...
                    className="mt-auto w-full bg-green-500 hover:bg-green-600 text-white font-bold py-2.5 px-4 rounded-lg text-center block transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 dark:focus:ring-offset-gray-800"
                >
                    {hasProgress && modul.progress_percentage > 0 ? 'Lanjutkan Belajar' : 'Mulai Belajar'}
                </Link>
            </div>
        </div>
    );
