        ...
        <div className="py-4 sm:py-6 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto space-y-6">
            <div className="grid grid-cols-12 gap-4 items-start">
                ...
                <motion.div
                    ...
                    className="col-span-12 flex flex-col lg:flex-row items-stretch lg:items-end justify-between gap-3 sm:gap-4 border-b border-slate-100 dark:border-slate-800 pb-4 sm:pb-4"
                >
                        ...
                        <div className="relative group shrink-0 flex flex-col sm:flex-row gap-3 sm:gap-4 items-start sm:items-center">
                            ...
                            <div className="pt-1 sm:pt-0">
                                ...
                                <h1 className="text-2xl sm:text-4xl lg:text-6xl font-[1000] text-slate-900 dark:text-white tracking-tighter leading-[0.9] relative z-10 mb-3">
                                    Halo, <br />
                ...
                <div className="hidden lg:flex col-span-4 flex-col space-y-4">
                    {/* Weekly Journey full */}
                    <WeeklyJourney compact />
