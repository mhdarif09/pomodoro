            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                <div className="space-y-4 relative">
                    ...
                    <label className="block">
                        ...
                        <input type="number" value={customFocusTime} onChange={(e) => handleCustomTimeChange('focus', e.target.value)} className="mt-1 block w-full rounded-md bg-slate-100 dark:bg-slate-700 border-transparent focus:border-teal-500 focus:ring-teal-500" min="1" />
                    </label>
                    <label className="block">
                        <span className="text-sm text-slate-600 dark:text-slate-400">Waktu Istirahat (menit)</span>
                        <input type="number" value={customBreakTime} onChange={(e) => handleCustomTimeChange('break', e.target.value)} className="mt-1 block w-full rounded-md bg-slate-100 dark:bg-slate-700 border-transparent focus:border-teal-500 focus:ring-teal-500" min="1" />
                    </label>
                ...
                <div className="space-y-3 relative">
                    ...
                    <button onClick={addBlockedUrl} className="text-sm font-semibold text-teal-600 dark:text-teal-400 hover:underline flex items-center gap-1">
