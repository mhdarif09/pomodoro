...
export default function WhatsAppWarningModal() {
    ...
    const [open, setOpen] = useState(!user.phone);
                                    ...
                                    <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                                        ...
                                        <div className="mt-2">
                                            <p className="text-sm text-gray-500">
                                                Anda belum mengatur nomor WhatsApp. Fitur reminder tugas dan notifikasi penting tidak akan berfungsi tanpa nomor WhatsApp.
                                            </p>
                                        </div>
                                    </div>
                                </div>
