...
Route::post('/api/wa/incoming', [\App\Http\Controllers\WhatsAppBotController::class, 'handle'])->name('whatsapp.incoming');
...
Route::get('/desktop/login-with-token', [\App\Http\Controllers\DesktopController::class, 'loginWithToken'])
    ->middleware('throttle:3,1')
    ->name('desktop.login-with-token');
